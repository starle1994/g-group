...
@section('content')
<div class="row gs-group-list-item">
        ...
        <div class="content">
            <div class="row top">
                <div class="col-sm-6 avt-parent">
                    <img src="images/gs-group-list-item/anh-cha.jpg" alt="">
                </div>

                <!-- <div class="col-sm-6 paraph">
                    <p>
                        2016-12-30(金) <br>
                        <span class="year">忘年会 2016</span> <br>
                        2016年も終わりということで、メンバーで忘年会を開催!! <br>
                        2016年もお疲れ様でした!! <br>
                    </p>
                </div> -->
            </div>
            ...
            <div class="row main">
                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a1.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a3.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a4.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a5.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a6.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a7.jpg" alt="">
                    
                </div>

                <div class="col-sm-6 avatar">
                    <img src="images/gs-group-list-item/a8.jpg" alt="">
