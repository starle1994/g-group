...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$castfeature->description), array('class'=>'form-control ckeditor')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('content', old('content',$castfeature->content), array('class'=>'form-control ckeditor')) !!}
    </div>
</div>
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
