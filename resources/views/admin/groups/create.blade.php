...
{!! Form::open(array('route' => config('quickadmin.route').'.groups.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('romaji_name', old('romaji_name'), array('class'=>'form-control')) !!}
