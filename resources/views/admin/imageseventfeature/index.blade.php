...
<p>{!! link_to_route(config('quickadmin.route').'.imageseventfeature.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
<td>{{ isset($row->eventsfeature->name) ? $row->eventsfeature->name : '' }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.imageseventfeature.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
