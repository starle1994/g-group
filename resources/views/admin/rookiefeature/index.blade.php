...
<p>{!! link_to_route(config('quickadmin.route').'.rookiefeature.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>

@if ($rookiefeature->count())
...
<td>{{ $row->description }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.rookiefeature.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
