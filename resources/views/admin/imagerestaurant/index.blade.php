...
<p>{!! link_to_route(config('quickadmin.route').'.imagerestaurant.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}</p>
...
<td>{{ isset($row->restaurant->name) ? $row->restaurant->name : '' }}</td>
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.imagerestaurant.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
