                    ...
                    @foreach ($group_ranking as $key =>$group)
                            ...
                            <div class="col-xs-2 item" style="margin-bottom: 20px;">
                                ...
                                <div class="av-main">
                                    ...
                                    @endif
                                    <div class="avt-lf">
                                        <a href="{{(isset($group->godstaffs) && ($group->godstaffs != null)) ? route('staff-detail',base64_encode($group->godstaffs->id)) : ''}}"><img class="avt-img"  src="{{(isset($group->godstaffs) && ($group->godstaffs != null)) ? asset('uploads/'.$group->godstaffs->image) : asset('css/css/images/gigolo/nothing.png') }}" alt=""></a>
                                    </div>
                                </div>
